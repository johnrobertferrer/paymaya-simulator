<template>
    <div class="wrapper">
        <v-row>
            <v-col v-show="waitingList.length > 0" cols="12" md="6" class="green lighten-3 py-6 px-10 px-md-12">
            ...
            <v-col v-show="doneList.length > 0" cols="12" md="6" class="red lighten-3 py-6 px-10 px-md-12">
                <div class="list-group-item">
                    <v-list-item-title class="headline my-2 text-center font-weight-medium">
                        Done
                    </v-list-item-title>
